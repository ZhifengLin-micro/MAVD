...
library(dplyr)
library(ggplot2)
TPRFPR <- read.delim("/public/linzhf/results/TPRFPR1.txt")
...
ggsave("FPR_TPR_effect10.pdf", plot = scatter_plot10, width =7, height = 6)
ggsave("FPR_TPR_effect5.pdf", plot = scatter_plot5, width =7, height = 6)
ggsave("FPR_TPR_effect2.pdf", plot = scatter_plot2, width =7, height = 6)
ggsave("FPR_TPR_effect1.pdf", plot = scatter_plot1, width =7, height = 6)
