...
library(dplyr)
library(ggplot2)
TPRFPR <- read.delim("/public/linzhf/results/3.TPRFPR/TPRPrecision1.txt")
...
ggsave("Precision_TPR_effect10.pdf", plot = scatter_plot10, width =18, height = 8)
ggsave("Precision_TPR_effect5.pdf", plot = scatter_plot5, width =18, height = 8)
ggsave("Precision_TPR_effect2.pdf", plot = scatter_plot2, width =18, height = 8)
ggsave("Precision_TPR_effect1.pdf", plot = scatter_plot1, width =18, height = 8)
