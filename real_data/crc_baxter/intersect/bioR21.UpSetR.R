...
library(UpSetR)
outFile="intersectDAA.txt"        #输出交集基因文件
outPic="upset.pdf"                  #输出图片
# setwd("E:/2023biyeketi/20240309realdata/Testing_Bias_robustness/Diarrhea/cdi_schubert/intersect")    #设置工作目录
...
upset(upsetData,
      ...
      sets.x.label = "Number of discoveries")
dev.off()
